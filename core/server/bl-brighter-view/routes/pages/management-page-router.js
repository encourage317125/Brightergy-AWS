...
router.get("/", function(req, res, next) {
    ...
    authUtils.isAuthenticatedUser(req, true, function(findUserErr, currentUser) {
        if (findUserErr) {
            ...
            return utils.redirectToLoginPage(res, redirectTo);
            ...
            if(!permissionsUtils.userHaveAccessToPresent(currentUser)) {
                ...
                res.render("500", {
                    errors: consts.SERVER_ERRORS.PRESENTATION.NOT_ACCESSIBLE_PRESENT_APP,
                ...
                async.parallel([
                    ...
                    function(cb) {
                        ...
                        if(currentUser.role !== consts.USER_ROLES.BP) {
                            query.accounts = { $in: currentUser.accounts};
                        }
                    ...
                    function(cb) {
                        ...
                        if (err) {
                            ...
                            res.render("management", {
                                ...
                                currentUser: currentUser,
                                config: viewConfig,
                                availableWidgets:results[8],
                                presentations:results[9],
                                presentTemplates:results[10],
                                accounts: results[0],
                                foundUsers: results[1],
                                apps: results[2],
                                presentUsers:results[3],
                                admins: results[4],
                                assets: results[5],
                                groups: results[6],
