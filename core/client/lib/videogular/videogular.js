...
angular.module("com.2fdevs.videogular")
    .directive("vgMedia",
    ["$timeout", "VG_UTILS", "VG_STATES", "$templateCache", function ($timeout, VG_UTILS, VG_STATES, $templateCache) {
        return {
            restrict: "E",
            require: "^videogular",
            template: function (elem, attrs) {
                var vgType = attrs.vgType || "video";
                return $templateCache.get(attrs.vgTemplate || "vg-templates/vg-media-" + vgType);
