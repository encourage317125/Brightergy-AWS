...
.controller("angularIsotopeController", [
  "iso.config", "iso.topics", "$scope", "$timeout", "optionsStore", function(config, topics, $scope, $timeout, optionsStore) {
    ...
    scope = "";
    isoMode = "";
    console.log('ISO DEBUG');
    console.log('angularIsotopeController');
    $scope.$on(onLayoutEvent, function(event) {});
    $scope.layoutEventEmit = function($elems, instance) {
      console.log('ISO DEBUG');
      console.log('layoutEventEmit');
    ...
    $scope.updateMethod = function(name, params, container, cb) {
      console.log('ISO DEBUG');
    ...
    methodHandler = function(event, option) {
      ...
      console.log(event);
      var name, params, container;
      name = option.name;
      params = option.params;
      container = option.container;
      return $scope.updateMethod(name, params,container,null);
    };
...
.directive("isotopeContainer", ["$injector", "$parse", function($injector, $parse) {
    ...
    return {
      ...
      link: function(scope, element, attrs) {
        ...
        console.log(attrs);
        console.log(attrs.isoOptionsSubscribe);
        console.log(attrs.isoMethodSubscribe);
        if (isoOptions) {
